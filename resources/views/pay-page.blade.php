...
<head>
    ...
    <title>{{ __("vFLOUS - Money Transfer with QR Code") }}</title>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="{{ asset('public/vflous/favicon.png') }}" type="image/x-icon">
    <!-- bootstrap css link -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('public/vflous/css/style.css') }}">
                ...
                <div class="col-lg-5">
                    <form class="demo-payment-form" method="POST" action="{{ route('pay.initiate.payment') }}">
                        ...
                        <div class="title-area mb-20">
                           <h3>{{ __("VFLOUS Merchant Website") }}</h3>
                        </div>
                        ...
                        <div class="badge-area mt-20 text-center">
                            <span class="form-text powered-badge"><i class="fas fa-bolt"></i> {{ __("Powered by vFLOUS") }}</span>
                        </div>
                    </form>
                </div>
            </div>
...
<!-- bootstrap js -->
<!-- jquery -->
<script src="{{ asset('public/vflous/') }}/js/jquery-3.5.1.min.js"></script>
