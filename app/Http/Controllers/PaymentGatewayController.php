...
class PaymentGatewayController extends Controller
{
    ...
    public function getToken(){
       try{
        $client = new Client();
        $response = $client->request('POST', 'https://vflous.com/pay/sandbox/api/v1/authentication/token', [
            'json' => [
                'client_id' => "/* HERE YOUR CLIENT ID KEY */",
                'secret_id' =>   "/* HERE YOUR SECRET ID KEY */",
            ],
            'headers' => [
    ...
    public function initiatePayment(Request $request){
        ...
        try{
            ...
            $response = $client->request('POST', 'https://vflous.com/pay/sandbox/api/v1/payment/create', [
                'json' => [
